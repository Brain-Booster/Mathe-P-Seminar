    ...
    >
      ...
      >
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
          <h3 style={{ margin: 0, color: theme === 'dark' ? '#e0e0e0' : '#333' }}>Settings</h3>
          <button 
        ...
        <div style={{ padding: '10px 0' }}>
          <h4 style={{ margin: '0 0 15px 0', color: theme === 'dark' ? '#e0e0e0' : '#333', fontSize: '16px' }}>Application Settings</h4>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '15px' }}>
            <div style={{ display: 'flex', alignItems: 'center' }}>
              ...
              <span style={{ color: theme === 'dark' ? '#e0e0e0' : '#333', fontWeight: '500' }}>Dark Mode</span>
            </div>
          ...
          <h4 style={{ margin: '20px 0 15px 0', color: theme === 'dark' ? '#e0e0e0' : '#333', fontSize: '16px' }}>Color Theme</h4>
