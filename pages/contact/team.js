...
import { getClientProjects, getClientProjectsSync, updateServerProjects } from '../../models/models';
...
export default function AdminTeam() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('[DEBUG] Response from /api/team:', response.status);
  ...
  const handleNewMember = () => {
    console.log('handleNewMember called, setting activeTab to new');
    setSelectedMember(null);
    setFormData({
      id: null,
      name: '',
        ...
        <div style={{ width: '100%', maxWidth: '1200px', margin: '0 auto' }}>
          ...
          {(activeTab === 'edit' || activeTab === 'new') && (
            <div style={{ 
              ...
              {console.log('[DEBUG] Rendering team member form, activeTab:', activeTab, 'formData:', formData)}
              <form onSubmit={e => { console.log('[DEBUG] Submit button clicked'); handleSubmit(e); }}>
                    ...
                    <div style={{ flex: 1 }}>
                      <div style={{ marginBottom: '1rem' }}>
                        ...
                        <input 
                          ...
                          name="name"
                          value={formData.name}
                          onChange={e => { console.log('[DEBUG] Name changed:', e.target.value); handleInputChange(e); }}
                          required
                          style={{
                            width: '100%',
                            padding: '0.75rem',
                      ...
                      <div style={{ marginBottom: '1rem' }}>
                        ...
                        <input 
                          ...
                          onChange={e => { console.log('[DEBUG] Nachname changed:', e.target.value); handleInputChange(e); }}
                          required
                          style={{
                            width: '100%',
                            padding: '0.75rem',
